        ...
        <div class="container">
            ...
            <img src={rating} alt="" />
                        ...
                        <div class="lawyer_reviews_item">
                            <img src={lawyer5} alt="" />
                            <div class="lawyer_page_review">
                                <h4>TARUN SINGH- <img src={verified} alt="" /> Verified</h4>
                                <div class="lawyer_ratings">
                                <div className="rating_img">
                                <img src={star} alt="" />
            <img src={star} alt="" />
            ...
            <div class="lawyer_page_faqs">
                ...
                <div class="faq_item">
                  <details>
                    ...
                    <div class="answer">
                    Harshwardhan Sharma brings over 8 years of experience in various areas of law, specializing in family law, criminal defense, and corporate law. He adeptly handles complex family law matters, including divorce, child custody, and adoption, ensuring his clients receive compassionate support during challenging times.
                    </div>
                ...
                <div class="faq_item">
                  <details>
                    ...
                    <div class="answer">
                    Booking an appointment with Harshwardhan Sharma is easy! You can schedule a consultation by filling out our online contact form, where you can provide your details and preferred times. Alternatively, you can call our office directly at 9992265434 to speak with a member of our team who will assist you in finding a suitable time. We look forward to helping you with your legal needs!
                    </div>
